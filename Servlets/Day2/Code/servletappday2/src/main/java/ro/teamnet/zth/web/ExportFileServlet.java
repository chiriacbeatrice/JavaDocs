...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // TODO 1: Iterate through Enumeration of parameter names from the request object and put inside paramsMap
        // TODO 1: each parameter send from request
        ...
        try (InputStream reportStream = getClass().getResourceAsStream(jasperPath)) {
            ...
            response.setHeader( "Content-Disposition", "filename="+passedTemplate+"."+passedFileType);
