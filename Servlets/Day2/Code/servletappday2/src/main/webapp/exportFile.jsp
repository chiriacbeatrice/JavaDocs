    ...
    function exportFile() {
        ...
        if (username != null && username != "") {
            ...
            // TIP: Remember that the application context it's named servlet-app
               ...
               window.open("/servlet-app-day2/exportFile?template=UsernameReport&fileType=pdf&username=" + username);
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("/servlet-app-day2/exportFile?template=UsernameReport&fileType=pdf" );
